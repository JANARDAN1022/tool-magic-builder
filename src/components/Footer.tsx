      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link to="/" className="inline-block mb-4">
              <span className="text-2xl font-bold">MagicTools</span>
            </Link>
            <p className="text-muted-foreground max-w-md">
              Transform your business with custom tools created in minutes, not months.
              No coding required.
            </p>
          </div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} MagicTools. All rights reserved.
          </p>
